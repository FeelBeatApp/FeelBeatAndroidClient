  ...
  private fun fetchGameResults() {
    viewModelScope.launch {
      val results =
          listOf(
                  PlayerWithResult(
                      Player("User123", R.drawable.userimage), ResultStatus.CORRECT, 10),
                  PlayerWithResult(Player("User456", R.drawable.userimage), ResultStatus.WRONG, 7),
                  PlayerWithResult(
                      Player("User789", R.drawable.userimage), ResultStatus.NORESPONSE, 1))
